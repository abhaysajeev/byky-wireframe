...
urlpatterns = [
    ...
    path(
        "tracking/antenna-registration/",
        views.AntennaRegistrationView.as_view(
            template_name="tracking_antenna_registration.html",
            screen_no="8.1",
            screen_title="Antenna Registration",
            module_label="Vehicle Tracking Management",
            legacy_page="StationAntennaManagement.aspx",
            tier="A",
            phase=5,
            purpose="To configure UHF RFID reader hardware units, gate antenna IDs, IP addresses, TCP ports, MAC addresses, gate orientation and station branch bindings.",
            layout="Form Panel (Antenna Code, Antenna Name, Station Branch, Reader IP Address, TCP Port, MAC Address, Gate Direction, Antenna Gain dBm), Configured Station Antennas DataGrid.",
        ),
        name="tracking-antenna-registration",
    ),
    path(
        "tracking/antenna-branch-mapping/",
        views.AntennaBranchMappingView.as_view(
            template_name="tracking_antenna_branch_mapping.html",
            screen_no="8.1b",
            screen_title="Antenna Branch Mapping",
            module_label="Vehicle Tracking Management",
            legacy_page="StationAntennaManagement.aspx",
            tier="A",
            phase=5,
            purpose="To view and reassign which station branch each registered antenna gate belongs to.",
            layout="Filter Bar (Branch, Direction), Antenna-to-Branch Mapping DataGrid.",
        ),
        name="tracking-antenna-branch-mapping",
    ),
    path(
        "tracking/branch-vehicle-rfid-tag-mapping/",
        views.RfidTagMappingView.as_view(
            template_name="tracking_branch_vehicle_rfid_tag_mapping.html",
            screen_no="8.2",
            screen_title="Branch - Vehicle - RFID Tag Mapping",
            module_label="Vehicle Tracking Management",
            legacy_page="RfidTagMapping.aspx",
            tier="A",
            phase=5,
            purpose="To view and edit the RFID Gen2 EPC tag physically bound to each vehicle, and the station branch it is currently assigned to.",
            layout="Vehicle Selection Dropdown, Tag EPC Hex Code Input, Tag Installation Location, Active Mapped RFID Tags DataGrid.",
        ),
        name="tracking-branch-vehicle-rfid-tag-mapping",
    ),
    path(
        "tracking/antenna-tracking-monitor/",
        views.AntennaTrackingMonitorView.as_view(
            template_name="tracking_antenna_tracking_monitor.html",
            screen_no="8.4",
            screen_title="Antenna Tracking Monitor",
            module_label="Vehicle Tracking Management",
            legacy_page="RfidGateMonitor.aspx",
            tier="C",
            phase=5,
            purpose="To display real-time RFID tag read streams at station entry/exit gates, audit gate clearance events, and flag unauthorized vehicle movements.",
            layout="Station Branch Selection Header, Gate Status Summary Cards, Real-Time Tag Event Stream Grid, Security Siren Controls.",
        ),
        name="tracking-antenna-tracking-monitor",
    ),
    path(
