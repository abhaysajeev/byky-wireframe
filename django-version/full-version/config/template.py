...
TEMPLATE_CONFIG = {
    ...
    # BYKY primary red is applied via src/assets/css/byky-brand.css (#CC0000),
    # not via primary_color -- that path only works while the customizer JS is loaded.
    "theme": 'light',                 # BYKY: locked to light. Dark mode is out of scope.
